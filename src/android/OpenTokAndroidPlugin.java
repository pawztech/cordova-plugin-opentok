 ...
 Session.StreamPropertiesListener {
  ...
  PublisherKit.PublisherListener, Publisher.CameraListener {
   ...
   public void destroyPublisher() {
    ...
    if (null != parent) {
      parent.removeView(viewContainer.mView);
      // NEEDED? parent.addView(viewContainer.mView);
     }
   ...
   public void run() {
    ...
    /*try {
      ...
      Log.e(TAG, "error when trying to retrieve publish audio/video property");
     }*/
  ...
  public void onConnected(Session arg0) {
   ...
   triggerJSEvent("sessionEvents", "sessionConnected - Exception?", data);
  }
